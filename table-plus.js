class TablePlus {
  ...
  renderControls() {
    ...
    resetBtn.className = 'bg-gray-400 text-white px-3 py-1.5 rounded-md text-sm hover:bg-gray-500';
    resetBtn.onclick = () => {
  ...
  createColumnVisibilityDropdown() {
    ...
    filterBtn.className = 'bg-gray-600 text-white px-3 py-1.5 rounded-md text-sm hover:bg-gray-700 relative transition-colors';
